...
class MovieAdapter(private val movies: ArrayList<Movie>, private val listener:OnAdaptelListener) : RecyclerView.Adapter<MovieAdapter.MovieViewHolder>() {
